  ...
  const handleSubmit = async (e) => {
    ...
    if (isLoginMode) {
      ...
      try {
        ...
        // Redirect logic for successful login (if required)
        console.log("Login successful! Redirect user if necessary.");
      } catch (error) {
    ...
    <div className="flex flex-col items-center py-10 px-4 bg-gradient-to-b from-blue-200 via-white to-blue-100 min-h-screen font-poppins">
      {registrationSuccess ? (
        ...
        >
          ...
          <button
            onClick={() => setIsLoginMode(true)} // Change to login mode without redirecting
        ...
        <>
          ...
          {!isLoginMode && (
            ...
            >
              Are you a Teacher, Principal, Headmaster, or Social Worker? Join
              us as a Global Innovator Olympiad partneer! Fill out the form to
              get started.
            </motion.p>
          )}
          ...
          >
            ...
            <motion.button
              ...
              } text-white text-xl py-4 px-8 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-400 transition duration-300`}
